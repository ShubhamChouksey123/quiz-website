...
2. **Application Directory Structure**
   ...
   - Set ownership to `999:999` (PostgreSQL Docker user)
...
- **Problem**: PostgreSQL Docker container requires specific ownership (`999:999`) and permissions (`750`) for data directory
